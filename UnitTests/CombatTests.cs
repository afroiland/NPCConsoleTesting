...
namespace UnitTests
{
    class CombatTests
    {
        ...
        {
            new Combatant("testChar1", 10, 0, 10, 1, 1, 4, 1, 1),
            new Combatant("testChar2", 10, 0, 10, 1, 1, 4, 1, 1),
            new Combatant("testChar3", 10, 0, 10, 1, 1, 4, 1, 1)
        };
        ...
        public void Simultaneous_init_allows_attack_from_dead_combatant()
        {
            ...
            {
                new Combatant("testChar1", 1, 0, 10, 1, 1, 4, 1, 1),
                new Combatant("testChar2", 1, 0, 10, 1, 1, 4, 1, 1)
            };
