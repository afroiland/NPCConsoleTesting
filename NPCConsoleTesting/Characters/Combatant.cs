...
namespace NPCConsoleTesting
{
    public class Combatant : BaseCharacter, ICombatant
    {
        ...
        public Combatant(string charName, string charClass, int charLevel, int charHp, int charInitMod, int charAc, int charThac0,
            int charNumOfAttackDice, int charTypeOfAttackDie, int charDmgModifier, List<string> charSpells = null)
        {
            Name = charName;
